...
export const FRAMEWORKS = {
  ...
  okr: {
    ...
    description: 'Objectives, Key Results, Initiatives, Alignment, Metrics, Timeline',
    categories: ['Objectives', 'KeyResults', 'Initiatives', 'Alignment', 'Metrics', 'Timeline'],
    categoryLabels: {
      KeyResults: 'Key Results',
      Alignment: 'Strategic Alignment',
      Timeline: 'Implementation Timeline'
    },
    scoreField: 'ExecutionReadiness',
    scoreLabel: 'Execution Readiness Score',
    layout: '2x3',
    colors: {
      Objectives: { bg: 'bg-indigo-50', border: 'border-indigo-200', text: 'text-indigo-700', header: 'bg-indigo-100' },
      KeyResults: { bg: 'bg-cyan-50', border: 'border-cyan-200', text: 'text-cyan-700', header: 'bg-cyan-100' },
      Initiatives: { bg: 'bg-emerald-50', border: 'border-emerald-200', text: 'text-emerald-700', header: 'bg-emerald-100' },
      Alignment: { bg: 'bg-violet-50', border: 'border-violet-200', text: 'text-violet-700', header: 'bg-violet-100' },
      Metrics: { bg: 'bg-amber-50', border: 'border-amber-200', text: 'text-amber-700', header: 'bg-amber-100' },
      Timeline: { bg: 'bg-rose-50', border: 'border-rose-200', text: 'text-rose-700', header: 'bg-rose-100' }
    },
    icons: {
      Objectives: '🎯',
      KeyResults: '📊',
